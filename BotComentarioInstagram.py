...
class InstagramBot:
    def __init__(self, username, password):
        ...
        """# Coloque o caminho para o seu geckodriver aqui, lembrando que você precisa instalar o firefox e 
        geckodriver na versão mais atual """
    ...
    def comente_nas_fotos_com_a_hashtag(self, hashtag):
        ...
        for i in range(
            1, 3
        ):  # Altere o segundo valor aqui para que ele desça a quantidade de páginas que você quiser: quer que ele
            # desça 5 páginas então você deve alterar de range(1,3) para range(1,5)
...
UserBot = InstagramBot("seuUsuario", "suaSenha")
UserBot.login()
